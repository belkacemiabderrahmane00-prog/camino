...
<body class="min-h-full flex flex-col {{ $fullscreen ? 'h-full overflow-hidden' : '' }}">
    ...
    {{-- Assistant CAMINO : une seule conversation partout (la carte et le guidage ont leur propre bouton) --}}
    @unless(request()->routeIs('walks.*'))<x-ai-assistant :floating="!$fullscreen" />@endunless
